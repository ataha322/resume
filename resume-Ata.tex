...
\section{Work Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{The research is in small ML models of the size of several kilobytes that are run on microcontrollers.}
        \resumeItem{The main task is to accommodate the resources of an Arduino computer for the model to run more effectively.}
      \resumeItemListEnd
